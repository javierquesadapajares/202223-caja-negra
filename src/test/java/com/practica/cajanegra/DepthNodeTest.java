...
public class DepthNodeTest {
    ...
    /* 
     * No funciona porque si pones el depth desde el root no te devuelve lo mismo que haciendo el depth del arbol,
     * tambien te dice que tiene el mismo nivel dede un nodo que no es hoja con uno que es hoja.
    @Test
